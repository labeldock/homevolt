...
const connectPath = zwavedriverpaths[os.platform()];

console.log("connecting to " + connectPath);

addZwaveEvents();
zwave.connect(connectPath);
...
setInterval(()=>{
  nodes.forEach((controller)=>{
    console.log("controller", controller)
    console.log("classes", controller.classes)
  })
},5000)

function addZwaveEvents (){
